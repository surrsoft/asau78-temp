...
function toggleMode() {
	console.log(`!!-!!-!! -> :::::::::::::: toggleMode() {220329123910}:${Date.now()}`) // del+
	if (isMoon) {
		changeMoonToSun();
	}
	else {
...
function changeMoonToSun() {
	if (isMoon) {
		...
		console.log(`!!-!!-!! 1238-2 -> :::::::::::::: changeMoonToSun() {220329123822}:${Date.now()}`) // del+
...
function changeSunToMoon() {
	if (!isMoon) {
		...
		console.log(`!!-!!-!! -> :::::::::::::: 1238-1 changeSunToMoon() {220329123756}:${Date.now()}`) // del+
