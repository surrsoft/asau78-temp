...
| :---:         | :---:                                |
| tel           | +7 920 659 7347                      |
| email         | [evgebar-1@mail.ru](mailto://evgebar-1@mail.ru)   |
...
За время практической работы овладел следующими технологиями:
...
|БИБЛИОТЕКИ| lodash, jQuery, Highcharts, Express.js, Mongoose, JsonServer | DevExtreme, moment.js, day.js, RxJava, bull.js, mocha, chai, Material UI, And Design, Chakra UI, Element UI, Bootstrap, Bulma, Formik, sinon.js, nock.js, Gulp, SheetJS, Socket.io, tsdx, jest | yup |
